...
class Sponsors extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    const SPONSORS_TABLE = InstallSchema::SPONSORS;
    const SPONSORS_ID = SponsorsInterface::SPONSORS_ID;
    ...
    {
        $this->_init(self::SPONSORS_TABLE,self::SPONSORS_ID);
    }
    ...
    {
        /* @var $object \Wagento\Sponsors\Model\Sponsors */
